...
public class Writer {
	 ...
	 * @throws IOException si erreur lors de l'ecriture dans le fichier
	 */ 
	 ...
	 * @throws IOException si erreur lors de la fermeture du fichier
	 */ 
	 ...
	 * @throws IOException si erreur lors de l'ouverture, de l'ecriture ou de la fermeture du fichier
	 */ 
